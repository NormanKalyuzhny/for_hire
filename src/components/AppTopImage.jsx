...
export default function AppTopImage() {
  ...
  return (
    <div className='top-container relative flex w-full min-w-[730px] h-500 text-4xl rounded-2xl text-shadow justify-center '>
      ...
      <div className="text-container flex flex-col justify-center p-4 min-w-[280px] text-left mr-10 z-10 mt-[4rem]">
        ...
        <div className='flex justify-center py-5'><DownloadBtn/></div>
      ...
      <div  className='flex flex-shrink-0 w-fit z-10'>
        <img src={appWide}  alt="app photo" className="w-full h-full object-contain"/>
      </div>
