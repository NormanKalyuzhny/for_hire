...
export default function DicePost() {
  ...
  return (
    <div className="dicePost text-shadow flex justify-between rounded-2xl shadow-container bg-container p-[1rem] w-[530px] transition-all duration-300 ease-in-out">
