...
export default function SVGNameAnimation({isAppContentVisible}) {
  ...
  const svgLetters = [
    ['.svgName path:nth-child(1)',{strokeDashoffset:0},{duration:2, ease: "easeInOut"}],
    ['.svgName path:nth-child(1)',{fill:"white"},{delay: 2, ease: "easeInOut"}],
    ['.svgName path:nth-child(2)',{strokeDashoffset:0},{duration:2, delay: 0.3, ease: "easeInOut"}],
    ['.svgName path:nth-child(2)',{fill:"white"},{delay: 2.3, ease: "easeInOut"}],
    ['.svgName path:nth-child(3)',{strokeDashoffset:0},{duration:2, delay: 0.6, ease: "easeInOut"}],
    ['.svgName path:nth-child(3)',{fill:"white"},{delay: 2.6, ease: "easeInOut"}],
    ['.svgName path:nth-child(4)',{strokeDashoffset:0},{duration:2, delay: 0.9, ease: "easeInOut"}],
    ['.svgName path:nth-child(4)',{fill:"white"},{delay: 2.9, ease: "easeInOut"}],
    ['.svgName path:nth-child(5)',{strokeDashoffset:0},{duration:2, delay: 1.2, ease: "easeInOut"}],
    ['.svgName path:nth-child(5)',{fill:"white"},{delay: 3.2, ease: "easeInOut"}],
    ['.svgName path:nth-child(6)',{strokeDashoffset:0},{duration:2, delay: 1.5, ease: "easeInOut"}],
    ['.svgName path:nth-child(6)',{fill:"white"},{delay: 3.5, ease: "easeInOut"}],
    ['.svgName path:nth-child(7)',{strokeDashoffset:0},{duration:2, delay: 1.8, ease: "easeInOut"}],
    ['.svgName path:nth-child(7)',{fill:"white"},{delay: 3.8, ease: "easeInOut"}],
    ['.svgName path:nth-child(1)',{opacity:0},{duration:1, delay: 3.5, ease: "easeInOut"}],
    ['.svgName path:nth-child(2)',{opacity:0},{duration:1, delay: 3.8, ease: "easeInOut"}],
    ['.svgName path:nth-child(3)',{opacity:0},{duration:1, delay: 4.1, ease: "easeInOut"}],
  ]
  
  useEffect(() => {
    if(isAppContentVisible === 'other'){
      svgLetters.forEach(([selector, style, options]) => {
        animate(selector, style, options);
      });
    }
  }, [isAppContentVisible,animate]);

  return (
    <div className="svg-container flex justify-center mb-[2rem] max-w-full h-fit ">
      <svg
        ref={scope} 
        className="svgName flex max-w-[1092px] h-[72.802px] vsm:w-full"
        width="508.3" 
        height="74.701" 
